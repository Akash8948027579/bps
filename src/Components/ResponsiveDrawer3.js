...
function ResponsiveDrawer3(props) {
    ...
    <div>
      ...
      <Grid sx={{ width: '200px', height: '220px', marginLeft: '10px', marginTop: '40px' }}>
          ...
          <Box sx={{ width: '200px', height: '35px' }}>
            ...
            <img src={img6} alt='' style={{ paddingLeft: '2px', paddingTop: '3px', marginTop:'0px' }} />
            <Typography sx={{ color: '#464255', fontSize: 16, fontWeight: '500', paddingLeft: '30px', marginTop: '-20px' }}>Manage User</Typography>
          </Box>
          ...
          <Grid style={{ width: '3px', height: '35px', background: 'blue', borderRadius: 2, marginLeft: '-4px' }} />
            <img src={img5} alt='' style={{ paddingLeft: '2px', marginTop: '-60px' }} />
            <Typography sx={{ color: '#0155A5', fontSize: 16, fontWeight: '700', paddingLeft: '30px', marginTop: '-50px' }}>Report</Typography>
          </Box>
        </Grid>
      </List>
      <Divider/> 
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      >
        <Toolbar>
          ...
          <Box sx={{ width:{sm:'500px', xs:'200px'}, marginTop:'25px', marginLeft:'5px' }}>
          <TextField placeholder='search here' sx={{ width: '100%', background: 'white', height: '100%', marginTop: '0px' }} InputProps={{ sx: { height: '40px' } }} />
          <Box sx={{marginLeft: {sm:'450px', xs:'170px'}}}><img src={img25} alt='' style={{  marginTop: '-70px', position: 'relative', height: '20px', width: '20px' }} /></Box>
        </Box>

         {/*----------------------------- Badges Icon visible from sm--------------------------------------------------------  */}
...
export default ResponsiveDrawer3;