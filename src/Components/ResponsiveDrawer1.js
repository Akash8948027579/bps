  ...
  const drawer = (
    <div>
      ...
      <Grid sx={{ width: '200px', height: '220px', marginLeft: '10px', marginTop: '40px' }}>
          ...
          <Box sx={{ width: '200px', height: '35px', marginTop: '0px', background: '#D8ECFF'  }}>
          <Grid style={{ width: '3px', height: '35px', background: 'blue', borderRadius: 2, marginLeft: '-4px' }} />
            <img src={img1} alt='' style={{ paddingLeft: '2px', paddingTop: '3px', marginTop: '-65px' }} />
            <Typography sx={{ fontSize: 16, fontWeight: '700', paddingLeft: '30px', marginTop: '-50px', color: '#0155A5' }}>Manage Booking</Typography>
          </Box>
          <Box sx={{ width: '200px', height: '35px' }}>
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      >
        <Toolbar>
          ...
          <Box sx={{ width:{sm:'500px', xs:'250px'}, marginTop:'25px', marginLeft:'5px' }}>
          <TextField placeholder='search here' sx={{ width: '100%', background: 'white', height: '100%', marginTop: '0px' }} InputProps={{ sx: { height: '40px' } }} />
          <Box sx={{marginLeft: {sm:'450px', xs:'220px'}}}><img src={img25} alt='' style={{  marginTop: '-70px', position: 'relative', height: '20px', width: '20px' }} /></Box>
        </Box>
