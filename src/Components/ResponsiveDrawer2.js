    ...
    <div>
      ...
      <Grid sx={{ width: '200px', height: '220px', marginLeft: '10px', marginTop: '40px' }}>
          ...
          <Grid style={{ width: '3px', height: '35px', background: 'blue', borderRadius: 2, marginLeft: '-4px' }} />
            <img src={img4} alt='' style={{ paddingLeft: '2px', paddingTop: '3px', marginTop: '-70px' }} />
            <Typography sx={{ color: '#0155A5', fontSize: 16, fontWeight: '700', paddingLeft: '30px', marginTop: '-55px' }}>Manage Customer</Typography>
          </Box>
          <Box sx={{ width: '200px', height: '35px'}}>
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <AppBar
        ...
        sx={{
          ...
          ml: { sm: `${drawerWidth}px` }, backgroundColor:'transparent', height:'15px', marginTop:'10px'
        }} elevation={0}
      >
        <Toolbar>
          <IconButton
